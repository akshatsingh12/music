...
const Header = () => {
  ...
  <Link className="mr-5 text-white text-900 hover:text-white" to='/categories'>Categories</Link>
      <Link className="mr-5 text-white text-900 hover:text-white" to='/newreleases'>New Releases</Link>
      <a className="mr-5 text-white text-900 hover:text-white" href='www.google.com'>Third Link</a>
      <a className="mr-5 text-white text-900 hover:text-white" href='www.google.com'>Fourth Link</a>
    </nav>
  ...
  <input className='search' type='text' value={i} onKeyPress={(p) => {
               p.key === "Enter" ? <Link className="mr-5 text-white text-900 hover:text-white"  to={`/${i}`}/>:<p>Wait...</p>
            }} onChange={(e)=>{setI(e.target.value)}} placeholder='  Search Here'/>
